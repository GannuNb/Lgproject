...
/>
  ...
  {/* What is Crumb Rubber Section */}
  <div className="mt-4">
    <h2 className="h3 font-weight-bold mb-3 products-heading">Crumb Rubber</h2>
    <p>Crumb rubber is made by reducing scrap tires into small, uniform granules. Inherent reinforcing materials, such as steel and fiber, are removed, along with other types of inert contaminants, such as dust, glass, or rock.</p>
    <p>Lakshmi Ganapathi Industries has the nationwide capacity to produce more than 52,000 tonnes of crumb rubber annually for a wide variety of commercial applications.</p>
  </div>

  {/* Production Process Section */}
  <div className="mt-4">
    <h2 className="h3 font-weight-bold mb-3">Production Process</h2>
    <p>We use the ambient mechanical grinding method. In the ambient mechanical grinding process, the breaking up of a scrap tire happens at or above normal room temperature. Ambient grinding is a multi-step technology and uses whole or pre-treated car or truck tires in the form of shred or chips, or sidewalls or treads. The rubbers, metals, and textiles are sequentially separated out. Tires are passed through a shredder, which breaks the tires into chips.</p>
    <p>The chips are fed into a granulator that breaks them into small pieces while removing steel and fiber in the process. Any remaining steel is removed magnetically and fiber through a combination of shaking screens and wind sifters. Finer rubber particles can be obtained through further grinding in secondary granulators and high-speed rotary mills.</p>
    <p>Ambient grinding is the production process used by the majority of crumb producers. The machines most commonly used for fine grinding in ambient plants are:</p>
    <ul>
  ...
  <div className="mt-4">
    <h2 className="h3 font-weight-bold mb-3">Applications for Crumb Rubber Granules</h2>
...
<img src={crumb1} alt="Company products" className="img-fluid" style={{ width: '60%', height: 'auto', display: 'block', margin: '0 auto' }} />
<img src={crumb2} alt="Company products" className="img-fluid" style={{ width: '60%', height: 'auto', display: 'block', margin: '0 auto' }} />
<img src={crumb3} alt="Company products" className="img-fluid" style={{ width: '60%', height: 'auto', display: 'block', margin: '0 auto' }} />
...
<div className="product-description my-5 p-4 m-5">
    ...
    <img src={crumb4} alt="Company products" className="img-fluid" style={{ width: '40%', height: 'auto', display: 'block', margin: '0 auto' }} />
<img src={crumb5} alt="Company products" className="img-fluid" style={{ width: '40%', height: 'auto', display: 'block', margin: '0 auto' }} />
